...
const Registration = () => {
                ...
                <div className='border p-10'>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="relative z-0 w-[420px] mb-6 group">
                            <input {...register("name")} type="text" name="name" className="block py-2.5 px-0 w-full text-sm text-orange-900 bg-transparent border-0 border-b-2 border-orange-300 appearance-none dark:text-white dark:border-orange-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " />
                        ...
                        <span className='text-sm text-orange-500'>Upload Profile Picture</span>
    ...
    "/>
                        ...
                        <div className="relative z-0 w-[420px] mb-6 group">
                            <input  {...register("phone")} type="number" name="email" className="block py-2.5 px-0 w-full text-sm text-orange-900 bg-transparent border-0 border-b-2 border-orange-300 appearance-none dark:text-white dark:border-orange-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " />
                        ...
                        <div className="relative z-0 w-[420px] mb-6 group">
                            <input {...register("confirm_password")} name="confirm_password" type="password" className="block py-2.5 px-0 w-full text-sm text-orange-900 bg-transparent border-0 border-b-2 border-orange-300 appearance-none dark:text-white dark:border-orange-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer" placeholder=" " />
                        ...
                        <div className='flex my-4 gap-10 items-center'>
                            <select {...register("userType")} className='w-full bg-orange-50 p-3' name="userType">
