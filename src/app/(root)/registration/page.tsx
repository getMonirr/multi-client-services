...
const Registration = () => {
                ...
                <div className='border p-10'>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="relative z-0 w-[420px] mb-6 group">
                            <input {...register("name")} type="text" name="name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                        ...
                        <div className='flex items-center my-4 gap-4'>
                            ...
                            <label className="block">
                                ...
                                <input {...register("picture")} type="file" className="block w-full text-sm text-slate-500
    ...
    "/>
                        ...
                        <div className="relative z-0 w-[420px] mb-6 group">
                            <input  {...register("phone")} type="number" name="email" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                            <label className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-gray-600 peer-focus:dark:text-gray-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Phone Number</label>
                        </div>
                        <div className="relative z-0 w-[420px] mb-6 group">
                        ...
                        <div className='flex my-4 gap-10 items-center'>
                            <select {...register("userType")} className='w-full bg-gray-50 p-3' name="userType">
                        ...
                        {error ? <p className='text-red-500 mt-4 flex animate-pulse'>{error} <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" />
                        </svg>
                        </p> : ""}
                        <p className='my-4'>Already Have an Account? <Link href="/login" className='text-gray-500 underline'>Login Here</Link> </p>
                        <SocialLogin />
                    </form>
                </div>
            </div>
